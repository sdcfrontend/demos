    ...
    if (window.DotMetricsInitScript == undefined) {
        ...
        function start(hasConsent){
            ...
            if(!hitDone){
                var imgUrl = 'https://uk-script.dotmetrics.net/hit.gif?id=11721&url=' + pageUrl + '&dom=' + domain + '&r=' + rand + '&pvs=' + pvs + '&pvid=' + pvid + '&c=' + hasConsent + '&tzOffset=' + tzOffset;
                var im=new Image;
                im.src = imgUrl;
                im.onload = function (){im.onload=null};

                var panelImgUrl = 'https://rm-script.dotmetrics.net/hit.gif?id=11721&url=' + pageUrl + '&dom=' + domain + '&r=' + rand + '&pvs=' + pvs + '&pvid=' + pvid + '&c=' + hasConsent + '&tzOffset=' + tzOffset;
                        ...
                        window.DotMetricsSettings =
                                    {
                                        ...
                                        ScriptUrl:  'https://uk-script.dotmetrics.net/Scripts/script.js?v=208',
                                        ScriptDebugUrl:  'https://download.dotmetrics.net/Script/script.debug.js?v=d0bcd841-ead4-4e77-a7b0-79181d25029c',
                                        ...
                                        AdexEnabled: false,
                                        AdexConfigUrl: 'https://script.api/DotMetrics.Script.Adex/adexConfig.js?v=208&id=11721',
