...
c.prototype=b.prototype;a.L=b.prototype;a.prototype=new c;a.prototype.constructor=a;a.Ll=function(d,e,f){for(var g=Array(arguments.length-2),h=2;h<arguments.length;h++)g[h-2]=arguments[h];return b.prototype[e].apply(d,g)}}
function Sa(a){return a}
;function Ta(a,b){if(Error.captureStackTrace)Error.captureStackTrace(this,Ta);else{var c=Error().stack;c&&(this.stack=c)}a&&(this.message=String(a));void 0!==b&&(this.Pa=b)}
...
return a}
var Zc={Hb:"allow-forms",Ib:"allow-modals",Jb:"allow-orientation-lock",Kb:"allow-pointer-lock",Lb:"allow-popups",Mb:"allow-popups-to-escape-sandbox",Nb:"allow-presentation",Ob:"allow-same-origin",Pb:"allow-scripts",Qb:"allow-top-navigation",Rb:"allow-top-navigation-by-user-activation"},ad=Va(function(){return $c()});
...
m.set=function(a,b,c){var d=!1;if("object"===typeof c){var e=c.Sl;d=c.secure||!1;var f=c.domain||void 0;var g=c.path||void 0;var h=c.ya}if(/[;=\s]/.test(a))throw Error('Invalid cookie name "'+a+'"');if(/[;\r\n]/.test(b))throw Error('Invalid cookie value "'+b+'"');void 0===h&&(h=-1);this.h.cookie=a+"="+b+(f?";domain="+f:"")+(g?";path="+g:"")+(0>h?"":0==h?";expires="+(new Date(1970,1,1)).toUTCString():";expires="+(new Date(Date.now()+1E3*h)).toUTCString())+(d?";secure":"")+(null!=e?";samesite="+e:"")};
...
m.clear=function(){this.i={};this.U=this.size=this.h.length=0};
m.remove=function(a){return this.delete(a)};
m.delete=function(a){return ie(this.i,a)?(delete this.i[a],--this.size,this.U++,this.h.length>2*this.size&&he(this),!0):!1};
...
m.set=function(a,b){ie(this.i,a)||(this.size+=1,this.h.push(a),this.U++);this.i[a]=b};
...
m.J=function(a){he(this);var b=0,c=this.U,d=this,e=new $d;e.h=function(){if(c!=d.U)throw Error("The map has changed since the iterator was created");if(b>=d.h.length)throw Zd;var f=d.h[b++];return a?f:d.i[f]};
...
function Wh(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||F("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.Kl||F("AUTHORIZATION"))||(a?b="Bearer "+B("gapi.auth.getToken")().Jl:b=sd([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=F("SESSION_INDEX",0),O("pageid_as_header_web")&&(d["X-Goog-PageId"]=F("DELEGATED_SESSION_ID")));return d}
...
v(R,xi);function Ii(a){R.call(this,"MISSING_OBJECT_STORE",{fb:a},Di.MISSING_OBJECT_STORE);Object.setPrototypeOf(this,Ii.prototype)}
...
{objectStoreNames:c,
dbName:b});if("AbortError"===e.name)return new R("UNKNOWN_ABORT",{objectStoreNames:c,dbName:b},e.message);e.args=[{name:"IdbError",Pl:e.name,dbName:b,objectStoreNames:c}];e.level="WARNING";return e}
...
var g=void 0!==b?self.indexedDB.open(a,b):self.indexedDB.open(a);var h=c.blocked,k=c.blocking,l=c.ub,n=c.upgrade,q=c.closed,r;g.addEventListener("upgradeneeded",function(p){try{if(null===p.newVersion)throw Error("Invariant: newVersion on IDbVersionChangeEvent is null");if(null===g.transaction)throw Error("Invariant: transaction on IDbOpenDbRequest is null");p.dataLoss&&"none"!==p.dataLoss&&wi("IDB_DATA_CORRUPTED",{reason:p.dataLossMessage||"unknown reason",dbName:Bi(a)});var z=f(),I=new cj(g.transaction);
...
pj.prototype.open=function(){function a(){return H(c,function g(){var h=this,k,l,n,q,r;return x(g,function(p){switch(p.h){case 1:return ra(p,2),w(p,h.i(h.name,h.options.version,e),4);case 4:k=p.i;a:{var z=h.options;for(var I=u(Object.keys(z.ka)),E=I.next();!E.done;E=I.next()){E=E.value;var Q=z.ka[E],V=void 0===Q.lb?Number.MAX_VALUE:Q.lb;if(k.h.version>=Q.qa&&!(k.h.version>=V)&&!k.h.objectStoreNames.contains(E)){z=E;break a}}z=void 0}l=z;if(void 0===l){p.B(5);break}if(h.j){p.B(6);break}h.j=!0;return w(p,
h.delete(),7);case 7:return vi(new R("DB_DELETED_BY_MISSING_OBJECT_STORE",{dbName:h.name,fb:l})),p.return(a());case 6:throw new Ii(l);case 5:return p.return(k);case 2:n=sa(p);if(n instanceof DOMException?"VersionError"!==n.name:"DOMError"in self&&n instanceof DOMError?"VersionError"!==n.name:!(n instanceof Object&&"message"in n)||"An attempt was made to open a database using a lower version than the existing version."!==n.message){p.B(8);break}return w(p,h.i(h.name,void 0,Object.assign(Object.assign({},
...
closed:b,ub:b,upgrade:this.options.upgrade};return this.h=d=a()};var rj=new pj("YtIdbMeta",{ka:{databases:{qa:1}},upgrade:function(a,b){b(1)&&$i(a,"databases",{keyPath:"actualName"})}});
...
m.gb=function(a){this.l=!0;if(void 0===a?0:a)this.C||hk(this)};
m.va=function(){var a=window.navigator.onLine;return void 0===a?!0:a};
m.Ra=function(){this.F=!0};
m.ba=function(a,b){return Je.prototype.ba.call(this,a,b)};
function fk(a){window.addEventListener("online",function(){return H(a,function c(){var d=this;return x(c,function(e){if(1==e.h)return w(e,d.X(),2);if(d.F&&O("offline_error_handling")){var f=bk().get("errors",!0);if(f){for(var g in f)if(f[g]){var h=new xi(g,"sent via offline_errors");h.name=f[g].name;h.stack=f[g].stack;h.level=f[g].level;Mf(h)}bk().set("errors",{},2592E3,!0)}}e.h=0})})})}
function ek(a){window.addEventListener("offline",function(){return H(a,function c(){var d=this;return x(c,function(e){return w(e,d.X(),0)})})})}
function hk(a){a.C=gg(function(){return H(a,function c(){var d=this;return x(c,function(e){if(1==e.h)return d.j?d.va()||!d.l?e.B(3):w(e,d.X(),3):w(e,d.X(),3);hk(d);e.h=0})})},dk)}
...
T.prototype.sendNetworkCheckRequest=T.prototype.X;T.prototype.listen=T.prototype.ba;T.prototype.enableErrorFlushing=T.prototype.Ra;T.prototype.getWindowStatus=T.prototype.va;T.prototype.monitorNetworkStatusChange=T.prototype.gb;T.prototype.isNetworkAvailable=T.prototype.K;T.getInstance=gk;function ik(a){a=void 0===a?{}:a;Je.call(this);var b=this;this.l=this.A=0;this.j=gk();var c=B("yt.networkStatusManager.instance.monitorNetworkStatusChange").bind(this.j);c&&c(a.Sa);a.eb&&(c=B("yt.networkStatusManager.instance.enableErrorFlushing").bind(this.j))&&c();if(c=B("yt.networkStatusManager.instance.listen").bind(this.j))a.ma?(this.ma=a.ma,c("ytnetworkstatus-online",function(){jk(b,"publicytnetworkstatus-online")}),c("ytnetworkstatus-offline",function(){jk(b,"publicytnetworkstatus-offline")})):
...
ik.prototype.X=function(a){return H(this,function c(){var d=this,e;return x(c,function(f){return(e=B("yt.networkStatusManager.instance.sendNetworkCheckRequest").bind(d.j))?f.return(e(a)):f.return(!0)})})};
...
function sk(){ok||(ok=new ik({eb:!0,Sa:!0}));return ok}
...
c.onFetchSuccess=function(E,Q){bi(p);I(E,Q)}}try{r&&d.retry&&!d.Ka.bypassNetworkless?(g.method="POST",d.Ka.writeThenSend?wk(q,g):Bk(q,g)):(g.method="POST",g.postParams||(g.postParams={}),Ng(q,g))}catch(E){if("InvalidAccessError"==E.name)p&&(bi(p),p=0),Nf(Error("An extension is blocking network request."));
...
Lk();c=u(a.S);for(d=c.next();!d.done;d=c.next())if(d=d.value,l.message&&l.message.match(d.Ol)){a=d.weight;break a}a=u(a.O);for(c=a.next();!c.done;c=a.next())if(c=c.value,c.Da(l)){a=c.weight;break a}a=1}l.sampleWeight=a;a=u(Gk);for(c=a.next();!c.done;c=a.next())if(c=c.value,c.la[l.name])for(e=u(c.la[l.name]),d=e.next();!d.done;d=e.next())if(f=d.value,d=l.message.match(f.regexp)){l.params["params.error.original"]=d[0];e=f.groups;f={};for(g=0;g<e.length;g++)f[e[g]]=d[g+1],l.params["params.error."+e[g]]=
d[g+1];l.message=c.za(f);break}l.params||(l.params={});a=Lk();l.params["params.errorServiceSignature"]="msg="+a.S.length+"&cb="+a.O.length;l.params["params.serviceWorker"]="false";y.document&&y.document.querySelectorAll&&(l.params["params.fscripts"]=String(document.querySelectorAll("script:not([nonce])").length));sb("sample").constructor!==qb&&(l.params["params.fconst"]="true");window.yterr&&"function"===typeof window.yterr&&window.yterr(l);if(0!==l.sampleWeight&&!Sk.has(l.message)){"ERROR"===b?(Mk.V("handleError",
l),O("record_app_crashed_web")&&0===Vk&&1===l.sampleWeight&&(Vk++,Fk("appCrashed",{appCrashType:"APP_CRASH_TYPE_BREAKPAD"})),Uk++):"WARNING"===b&&Mk.V("handleWarning",l);if(O("kevlar_gel_error_routing")){a=b;b:{c=u(Xk);for(d=c.next();!d.done;d=c.next())if(Wg(d.value.toLowerCase())){c=!0;break b}c=!1}if(c)c=void 0;else{d={stackTrace:l.stack};l.fileName&&(d.filename=l.fileName);c=l.lineNumber&&l.lineNumber.split?l.lineNumber.split(":"):[];0!==c.length&&(1!==c.length||isNaN(Number(c[0]))?2!==c.length||
...
){this.i=[];this.isReady=!1;this.j={};var a=this.h=new sn(!!F("WIDGET_ID_ENFORCE")),b=this.kb.bind(this);a.m=b;a.o=null;this.h.channel="widget";if(a=F("WIDGET_ID"))this.h.sessionId=a}
m=tn.prototype;m.kb=function(a,b,c){"addEventListener"===a&&b?(a=b[0],this.j[a]||"onReady"===a||(this.addEventListener(a,un(this,a)),this.j[a]=!0)):this.Ba(a,b,c)};
m.Ba=function(){};
...
;function zn(a){tn.call(this);this.listeners=[];this.api=a;this.addEventListener("onReady",this.onReady.bind(this));this.addEventListener("onVideoProgress",this.rb.bind(this));this.addEventListener("onVolumeChange",this.sb.bind(this));this.addEventListener("onApiChange",this.mb.bind(this));this.addEventListener("onPlaybackQualityChange",this.ob.bind(this));this.addEventListener("onPlaybackRateChange",this.pb.bind(this));this.addEventListener("onStateChange",this.qb.bind(this));this.addEventListener("onWebglSettingsChanged",
this.tb.bind(this))}
...
m.ob=function(a){vn(this,{playbackQuality:a})};
m.pb=function(a){vn(this,{playbackRate:a})};
...
m.sb=function(){vn(this,{muted:this.api.isMuted(),volume:this.api.getVolume()})};
...
m.tb=function(){var a={sphericalProperties:this.api.getSphericalProperties()};vn(this,a)};
m.dispose=function(){tn.prototype.dispose.call(this);for(var a=0;a<this.listeners.length;a++){var b=this.listeners[a];this.api.removeEventListener(b.eventType,b.listener)}this.listeners=[]};function An(a){L.call(this);this.i={};this.started=!1;this.connection=a;this.connection.subscribe("command",this.La,this)}
v(An,L);m=An.prototype;m.start=function(){this.started||this.h||(this.started=!0,this.connection.W("RECEIVING"))};
m.W=function(a,b){this.started&&!this.h&&this.connection.W(a,b)};
m.La=function(a,b,c){if(this.started&&!this.h){var d=b||{};switch(a){case "addEventListener":"string"===typeof d.event&&this.addListener(d.event);break;case "removeEventListener":"string"===typeof d.event&&this.removeListener(d.event);break;default:this.api.isReady()&&this.api.isExternalMethodAvailable(a,c||null)&&(b=Bn(a,b||{}),c=this.api.handleExternalCall(a,b,c||null),(c=Cn(a,c))&&this.W(a,c))}}};
m.addListener=function(a){if(!(a in this.i)){var b=this.nb.bind(this,a);this.i[a]=b;this.addEventListener(a,b)}};
m.nb=function(a,b){this.started&&!this.h&&this.connection.W(a,this.sa(a,b))};
m.sa=function(a,b){if(null!=b)return{value:b}};
m.removeListener=function(a){a in this.i&&(this.removeEventListener(a,this.i[a]),delete this.i[a])};
m.D=function(){var a=this.connection;a.h||nf(a.i,"command",this.La,this);this.connection=null;for(var b in this.i)this.i.hasOwnProperty(b)&&this.removeListener(b);L.prototype.D.call(this)};function Dn(a,b){An.call(this,b);this.api=a;this.start()}
...
En.prototype.l=function(a,b){this.h||this.i.V.apply(this.i,arguments)};function Fn(a,b,c){En.call(this);this.j=a;this.destination=b;this.id=c}
v(Fn,En);Fn.prototype.W=function(a,b){this.h||this.j.W(this.destination,this.id,a,b)};
...
v(Gn,L);Gn.prototype.W=function(a,b,c,d){this.h||a!==this.destination||(a={id:b,command:c},d&&(a.data=d),this.destination.postMessage(Oe(a),this.origin))};
...
;function On(a,b,c,d){L.call(this);var e=this;this.F=b;this.webPlayerContextConfig=d;this.na=!1;this.api={};this.aa=this.m=null;this.I=new M;this.i={};this.N=this.ea=this.elementId=this.oa=this.config=null;this.M=!1;this.l=this.A=null;this.fa={};this.Na=["onReady"];this.lastError=null;this.Ca=NaN;this.C={};this.Oa=new Hn(this);this.Z=0;this.j=this.o=a;Ud(this,Qa(Sd,this.I));Pn(this);Qn(this);Ud(this,Qa(Sd,this.Oa));c?this.Z=cg(function(){e.loadNewVideoConfig(c)},0):d&&(Rn(this),Sn(this))}
...
m.addEventListener=function(a,b){var c=this,d=Vn(this,b);d&&(0<=Wa(this.Na,a)||this.i[a]||(b=go(this,a),this.m&&this.m(a,b)),this.I.subscribe(a,d),"onReady"===a&&this.isReady()&&cg(function(){d(c.api)},0))};
...
function go(a,b){var c="ytPlayer"+b+a.F;a.i[b]=c;y[c]=function(d){var e=cg(function(){if(!a.h){a.I.V(b,d);var f=a.C,g=String(e);g in f&&delete f[g]}},0);
hb(a.C,String(e))};
return c}
