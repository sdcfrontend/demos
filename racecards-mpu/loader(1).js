...
function load_script(caller){
    ...
    create_script(protocol+'//player.h-cdn.com/loader.js?customer=sky_uk&no_conf=true&md5=1004536-5fed3159');
    create_script(protocol+'//player.h-cdn.com/config.js?customer=sky_uk&md5=108300-1a790f24');
}
